...
Since this is a test of time, and these were released at night, there's some general
"splat code all over the place" situations as I was grinding out a solution.  I also
created this simple framework to hang data/solvers on and so there's lots of copypasta
then back tracking to make the old code work in the new layout.  At the very least, I
got back to the proper answers with this new structure.  I may come back to some of
these and update them in the future.
